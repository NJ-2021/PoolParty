...
import {
  TransactionDetails,
  getTokenTransfersOnEthSepolia,
  getTransactionOnSepoliaByHash,
  getTransactionsOnEthSepolia,
} from "~~/lib/blockscout";
import {
...
const SafePage = () => {
  ...
  const refreshTransactions = async () => {
    ...
    if (!primaryWallet) return;
    const transactions = await getTransactionsOnEthSepolia(primaryWallet.address);
    const transfers = await getTokenTransfersOnEthSepolia(primaryWallet.address);
    ...
    for (const transfer of transfers) {
      const transactionDetail = await getTransactionOnSepoliaByHash(transfer.tx_hash);
  ...
  return (
    <div className="flex flex-col items-center gap-4 p-12 h-screen">
      <div className="flex flex-col justify-center items-center">
        <h1 className="font-bold text-4xl">Safe Smart Wallet</h1>
        <p className="text-lg">
      ...
      {safeDeployed ? (
        <div className="flex flex-col justify-center items-center gap-4">
          <div role="alert" className="border-white border w-fit alert">
            <div className="flex flex-row items-center gap-2">
              <div>
                ...
                <div className="flex flex-row items-center gap-4">
                  ...
                  {safeAddress && (
                    <div
                      className="flex flex-row items-center gap-1 hover:text-warning cursor-pointer"
          ...
          <div role="tablist" className="tabs-bordered w-full tabs">
            <input type="radio" name="my_tabs_1" role="tab" className="w-full tab" aria-label="ERC20 Transfer" />
            <div role="tabpanel" className="p-10 w-full tab-content">
              <div className="flex flex-col justify-center items-center gap-4">
                <div className="flex flex-col justify-center items-center gap-4 w-full">
                  ...
                  <label className="flex items-center gap-2 input-bordered w-full input">
            ...
            <div role="tabpanel" className="p-10 w-full tab-content">
              <div className="flex flex-col gap-4">
                <button className="w-fit btn btn-outline btn-sm" onClick={refreshTransactions}>
